...
% positionner un bateau sur la grille *
% enlever un bateau
% ajouter un bateau aléatoirement (*)
% faire une rotation
% indiquer qu'un joueur est prêt à commencer *
% indiquer que le joueur veut terminer la partie
% on peut attaquer une position *
